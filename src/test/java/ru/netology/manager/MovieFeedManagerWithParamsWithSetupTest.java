...
public class MovieFeedManagerWithParamsWithSetupTest {
    private MovieFeedManager manager = new MovieFeedManager(5);
    ...
    public void shouldShowAllMovieFeed() {
        ...
        MovieFeed[] expected = new MovieFeed[]{eleventh, tenth, ninth, eighth, seventh};
